...
This work received funding from the research project "[Synthetic FMCW-Lidar](https://www.fzd.tu-darmstadt.de/forschung/research_projects_fzd/synthetic_fmcw_lidar/standardseite_265.en.jsp)" which is financed with funds of LOEWE - Landes-Offensive zur Entwicklung Wissenschaftlich-ökonomischer Exzellenz, Förderlinie 3: KMU-Verbundvorhaben (State Offensive for the Development of Scientific and Economic Excellence).
